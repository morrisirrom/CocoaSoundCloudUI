...
- (UIView *)tableView:(UITableView *)aTableView viewForHeaderInSection:(NSInteger)section;
{
    ...
    NSDictionary* fontAttributes = @{NSFontAttributeName: [UIFont systemFontOfSize:15.0]};
    CGRect boundingRect = [text
                           boundingRectWithSize:CGSizeMake(CGRectGetWidth(self.tableView.bounds) - 2 * [self cellMargin], CGFLOAT_MAX)
